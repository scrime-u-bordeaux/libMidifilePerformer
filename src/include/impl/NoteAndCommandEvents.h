...
template<>
inline bool Events::correspond<commandData>(
  commandData const& cmd1,
  commandData const& cmd2
) {
...
inline bool Events::correspond<commandData>(
  ...
  return (
    (o != correspondOption::NONE) &&
    cmd1.id == cmd2.id &&
    (o == correspondOption::PITCH_ONLY || cmd1.channel == cmd2.channel)
  );
}
...
template<>
inline bool Events::correspond<noteData>(
  noteData const& note1,
  noteData const& note2
) {
...
inline bool Events::correspond<noteData>(
  ...
  return (
    ...
    (o == correspondOption::PITCH_ONLY || note1.channel == note2.channel)
  );
}
